import { OfferedRideCardType } from '../Interfaces/RidesType';
import './matchingcard.scss';

export const OfferedCard = ({rideDetails}:any) => {
  
  return (
    <div className='matching-card shadow' >
        ...
        <div className="matching-card-content">
            ...
            <div className="seat-price d-flex">
               <div className="seat">
                <label>Price</label>
                <p>{rideDetails.fairPerKm}$</p>
               </div>
               <div className="price">
                <label>Seats Offered</label>
                <p>{rideDetails.capacity}</p>
               </div>
            </div>
        </div>
    </div>
